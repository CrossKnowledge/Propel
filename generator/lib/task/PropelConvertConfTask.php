...
class PropelConvertConfTask extends AbstractPropelDataModelTask
{
     ...
     * @see        AbstractPropelDataModelTask#setOutputDirectory()
     */
    public function setOutputClassmapFile(string $outputFile): void
    {
        // this is a string, not a file
    ...
    public function main(): void
    {
        ...
        $output = "<?php\n";
        $output .= "// This file generated by Propel " . $phpconf['generator_version'] . " convert-conf target" . ($this->getGeneratorConfig()->getBuildProperty('addTimestamp') ? " on " . (new DateTime())->format('D M j H:i:s Y') : '') . "\n";
    ...
    protected function logClassMap($classMap): void
    {
     ...
     *
     * @param object $value The simplexml value object.
     *
     * @return mixed
     */
    private static function getConvertedXmlValue(object $value): mixed
    {
